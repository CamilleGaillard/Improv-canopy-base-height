...
inline void mnbrak(double (*func)(double, double *), double *aa, double *ax, double *bx, double *cx, double *fa, double *fb, double *fc ) 
{ 
...
inline double golden(double (*f)(double, double *), double *aa, double ax, double bx, double cx, double tol, double *xmin)
{ 
